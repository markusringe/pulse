...
/** @typedef {'smtp'|'sendmail'|'mailgun'|'none'} EmailProvider */
...
function defaultConfig() {
  return {
    ...
    sendmailFrom: "",
    /** Bestätigte Admin-Adresse für Mailgun-Testmails (nur diese Empfänger erlaubt). */
    confirmedAdminEmail: "",
    updatedAt: 0,
  };
}
...
function publicConfig(cfg) {
  ...
  return {
    ...
    confirmedAdminEmail: c.confirmedAdminEmail || "",
...
function sanitizeProvider(p) {
  ...
  if (v === "smtp" || v === "sendmail" || v === "mailgun" || v === "none") return v;
  return "none";
}
