...
/** Generische Platzhalter für die Datenschutz-Aufsicht (vor Produktivbetrieb ersetzen). */
const SUPERVISORY_PLACEHOLDER = {
  name: "Zuständige Datenschutzaufsichtsbehörde (Platzhalter)",
  address: "Musterstraße 2\n12345 Musterstadt",
  website: "https://example.invalid/aufsicht",
  email: "poststelle@example.invalid",
  phone: "+49 123 4567892",
};

/**
 * Generische Musterwerte für öffentliche Verwaltungen.
 * Vor dem produktiven Einsatz durch die verantwortliche Stelle ersetzen
 * (Admin unter #/admin/privacy oder data/privacy.json).
 */
const DEFAULTS = {
  ...
  supervisoryName: SUPERVISORY_PLACEHOLDER.name,
  supervisoryAddress: SUPERVISORY_PLACEHOLDER.address,
  supervisoryWebsite: SUPERVISORY_PLACEHOLDER.website,
  supervisoryEmail: SUPERVISORY_PLACEHOLDER.email,
  supervisoryPhone: SUPERVISORY_PLACEHOLDER.phone,
  adminSupervisory:
...
<p>Sie haben das Recht, sich bei einer Datenschutz-Aufsichtsbehörde zu beschweren (Art. 77 DSGVO), insbesondere am Ort Ihres gewöhnlichen Aufenthalts, Ihres Arbeitsplatzes oder des mutmaßlichen Verstoßes. Zuständig ist in der Regel:</p>
...
<p>Beschwerdeformular: über die Website der genannten Aufsichtsbehörde.</p>

<h2>4. Rechtsgrundlagen und Zwecke</h2>
<p>Es gelten die Verordnung (EU) 2016/679 (DSGVO), das Bundesdatenschutzgesetz (BDSG) und — für öffentliche Stellen — <strong>ergänzendes Landesdatenschutzrecht</strong>, soweit anwendbar. Welche Landesnorm im Einzelfall gilt, legt die verantwortliche Stelle fest.</p>
...
<ul>
<li><strong>Art. 6 Abs. 1 lit. e DSGVO</strong> — Wahrnehmung einer Aufgabe im öffentlichen Interesse bzw. in Ausübung öffentlicher Gewalt (Durchführung interaktiver Bürger- oder Mitarbeiterveranstaltungen, Erheben von Meinungsbildern ohne Klarnamenspflicht). Für öffentliche Stellen ist das die <strong>Hauptrechtsgrundlage</strong>; ergänzendes Landesrecht kann hinzutreten.</li>
...
<p>Kontaktweg: E-Mail an {{dsbEmail}} oder {{controllerEmail}}, telefonisch unter {{dsbPhone}} bzw. {{controllerPhone}}, postalisch an {{controllerName}}, {{controllerAddress}}. Für öffentliche Stellen können sich Besonderheiten aus § 34, § 35 BDSG und landesrechtlichen Regelungen ergeben; die/der DSB klärt dies im Einzelfall.</p>
...
function buildContext(rec, ctx = {}) {
  ...
  const kdgHtml = `<p>Das Kirchliche Datenschutzgesetz (KDG) gilt nur, wenn eine <strong>kirchliche Stelle</strong> Verantwortliche ist. Für kommunale und andere öffentliche Stellen ist das KDG in der Regel <strong>nicht</strong> einschlägig.</p>`;
...
module.exports = {
  DEFAULTS,
  SUPERVISORY_PLACEHOLDER,
  /** @deprecated Alias — bitte SUPERVISORY_PLACEHOLDER verwenden */
  UDIS: SUPERVISORY_PLACEHOLDER,
  MAX_VERSIONS,
  HTML_KEYS,
  escapeHtml,
  simpleMarkdown,
