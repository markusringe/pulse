  ...
  return {
    ...
    visibility: ["private", "public", "shared"].includes(src.visibility)
      ...
      : ["private", "public", "shared"].includes(prev.visibility)
        ? prev.visibility
        : "private",
    editorUserIds: Object.prototype.hasOwnProperty.call(src, "editorUserIds")
      ? sanitizeIdList(src.editorUserIds)
      : sanitizeIdList(prev.editorUserIds),
    presenterUserIds: Object.prototype.hasOwnProperty.call(src, "presenterUserIds")
      ? sanitizeIdList(src.presenterUserIds)
      : sanitizeIdList(prev.presenterUserIds),
    viewerUserIds: Object.prototype.hasOwnProperty.call(src, "viewerUserIds")
      ? sanitizeIdList(src.viewerUserIds)
      : sanitizeIdList(prev.viewerUserIds),
...
function publicEvent(ev, opts = {}) {
  ...
  return {
    ...
    endAt: ev.endAt,
    startTime,
    countdownActive: Boolean(startTime && remainingMs > 0),
