...
**Stand:** Programmversion **v1.4.2** · Hilfe-Katalog **Version 10** · **26 Artikel** · 2026-09-03.
...
| `frontend/help/articles.json` | Hilfe-Katalog v10 · Programm v1.4.2 (26 Artikel) |

---

*Bei Abweichungen gilt der Stand der HTML-Artikel unter `frontend/help/` (Programmversion **v1.4.2**, Katalog-Version in `articles.json`).*
