...
**Stand:** Programmversion **v1.2.2** · Hilfe-Katalog **Version 9** · **25 Artikel** · 2026-09-03.
...
| `frontend/help/articles.json` | Hilfe-Katalog v9 · Programm v1.2.2 (25 Artikel) |

---

*Bei Abweichungen gilt der Stand der HTML-Artikel unter `frontend/help/` (Programmversion **v1.2.2**, Katalog-Version in `articles.json`).*
