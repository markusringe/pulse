...
**Stand:** 2026-09-03 · **Programmversion:** v1.2.3
**Fassung:** 5 (Entwurf)
...
| Datenkategorien | Hilfe-Inhalte in `frontend/help/` (HTML, Katalog `articles.json`, **Version 9**, Programm **v1.2.3**; u. a. Auth/Login, Picker, Backups). Markdown-Spiegel: `docs/hilfe.md` (Programmversion im Kopf). Feedback ja/nein nur in `localStorage` (`pulse:help-feedback`, s. 5.3). Erstnutzer-Tour: `pulse:tour-done` / `pulse:tour-later`. |
