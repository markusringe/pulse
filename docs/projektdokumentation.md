...
**Stand:** Programmversion **v1.4.2** · Ist-Zustand aus dem Quellcode, 2026-09-03.
...
- **Markdown-Auszug für Druck/Schulung:** `docs/hilfe.md` (**26 Artikel**, Stand Katalog **Version 10**, Programm **v1.4.2**).
