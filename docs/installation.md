...
**Stand:** Programmversion **v1.4.3** · Ist-Zustand aus dem Repository (Node ≥ 22, npm, optional Docker Compose).
...
Optionen: `--tag v1.4.3` (festes Release), `--npm` / `--docker`, `--yes`, `--skip-backup`, `--json`.  
